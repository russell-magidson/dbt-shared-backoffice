...
with devTables as (
    ...
    from 
        {%- if schema == "eBI" -%} `us-atldm-test-dev-9198.tst_data_mart_eBI`
            {% elif schema == "BackOffice_DeDup "%} `rand-rusaweb.eBI_DeDup`
...
, qaTables as (
    ...
    from 
        {%- if schema == "eBI" -%} `us-atldm-test-qa-2114.acc_data_mart_eBI`
            {% elif schema == "BackOffice_DeDup "%} `us-ergbq-qa-e523.eBI_DeDup`
...
, prdTables as (
    ...
    from 
        {%- if schema == "eBI" -%} `us-atldm-test-prd-99b5.prd_data_mart_eBI`
            {% elif schema == "BackOffice_DeDup "%} `us-ergbq-prd-3693.eBI_DeDup`
